package lambdaexpressions.codingalong.usingcomparators;
...
public class UserComparator {
    ...
    public static void main(String[] args) {
        ...
        Comparator<User> cmpAge = Comparator.comparing(user -> user.getName());
        Comparator<User> comparator = cmpName.thenComparing(cmpAge);
        Comparator<User> reserved = comparator.reversed();
